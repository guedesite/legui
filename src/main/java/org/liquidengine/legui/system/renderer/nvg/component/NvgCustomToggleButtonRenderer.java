...
public class NvgCustomToggleButtonRenderer extends NvgDefaultComponentRenderer<CustomToggleButton> {

    @Override
    protected void renderSelf(CustomToggleButton toggleButton, Context context, long nanovg) {
    ...
    private void renderBackground(long nvg, CustomToggleButton agui, Vector2f pos, Vector2f size, Context context) {
