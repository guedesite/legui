...
public class AdvancedButton extends Component implements TextComponent {
     ...
     */
    public AdvancedButton(float x, float y, float width, float height) {
     ...
     */
    public AdvancedButton(Vector2f position, Vector2f size) {
     ...
     * @param height height of component.
     */
    public AdvancedButton(String text, float x, float y, float width, float height) {
     ...
     * @param size     size of component.
     */
    public AdvancedButton(String text, Vector2f position, Vector2f size) {
        super(position, size);
        initialize(text);
    }
