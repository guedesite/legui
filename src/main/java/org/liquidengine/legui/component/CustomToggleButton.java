...
public class CustomToggleButton extends Button {
     ...
     */
    public CustomToggleButton(String text, float x, float y, float width, float height) {
     ...
     * @param height height of component.
     */
    public CustomToggleButton(float x, float y, float width, float height) {
     ...
     */
    public CustomToggleButton(Vector2f position, Vector2f size) {
        super(position, size);
        initialize();
    }
    ...
    public boolean equals(Object o) {
        ...
        CustomToggleButton button = (CustomToggleButton) o;
