...
public class BlurLabel extends Component implements TextComponent {
     ...
     */
    public BlurLabel(float x, float y, float width, float height) {
     ...
     */
    public BlurLabel(Vector2f position, Vector2f size) {
     ...
     * @param height label height.
     */
    public BlurLabel(String text, float x, float y, float width, float height) {
     ...
     * @param size     label size.
     */
    public BlurLabel(String text, Vector2f position, Vector2f size) {
        super(position, size);
        initialize(text);
    }
